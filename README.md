...
| [**50. Oshi-Katsu Ticket Alert Bot**](./50-oshi-ticket-alert-bot) | **Personal/Hobby Automation.** Automatically tracks official news and social media buzz for your favorite artist's events. AI acts as an enthusiastic assistant, sending you an urgent, actionable push notification (via Slack DM, LINE, etc.) so you never miss a ticket entry deadline. | Schedule, HTTP Request, Gemini, Slack |
